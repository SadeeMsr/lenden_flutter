    ...
    var task = NavigableTask(
      ...
      steps: [
        ...
        QuestionStep(
          ...
          answerFormat: const SingleChoiceAnswerFormat(
            textChoices: [
              TextChoice(text: 'Architecture', value: 'Architecture'),
              TextChoice(text: 'IB', value: 'IB'),
              TextChoice(text: 'MGT', value: 'MGT'),
              TextChoice(text: 'MIS', value: 'MIS'),
              TextChoice(text: 'MKT', value: 'MKT'),
              TextChoice(text: 'SCM', value: 'SCM'),
              TextChoice(text: 'MAJ', value: 'MAJ'),
              TextChoice(text: 'ACN', value: 'ACN'),
              TextChoice(text: 'FIN', value: 'FIN'),
              TextChoice(text: 'HRM', value: 'HRM'),
              TextChoice(text: 'BBA General', value: 'BBA General'),
              TextChoice(text: 'CE', value: 'CE'),
              TextChoice(text: 'CS', value: 'CS'),
              TextChoice(text: 'CSE', value: 'CSE'),
              TextChoice(text: 'EEE', value: 'EEE'),
              TextChoice(text: 'ECE', value: 'ECE'),
              TextChoice(text: 'Mathematics', value: 'Mathematics'),
              TextChoice(text: 'Physics', value: 'Physics'),
              TextChoice(
                  text: 'Biochem and Biotech', value: 'Biochem and Biotech'),
              TextChoice(text: 'Biotech', value: 'Biotech'),
              TextChoice(text: 'Microbiology', value: 'Microbiology'),
              TextChoice(text: 'BPharm', value: 'BPharm'),
              TextChoice(text: 'CMN', value: 'CMN'),
              TextChoice(text: 'SOC', value: 'SOC'),
              TextChoice(text: 'ENV', value: 'ENV'),
              TextChoice(text: 'GSG', value: 'GSG'),
              TextChoice(text: 'LLB', value: 'LLB'),
              TextChoice(text: 'ECN', value: 'ECN'),
              TextChoice(text: 'ANT', value: 'ANT'),
              TextChoice(text: 'ENG', value: 'ENG'),
              TextChoice(text: 'HISTORY', value: 'HISTORY'),
            ],
          ),
        ),
        QuestionStep(
